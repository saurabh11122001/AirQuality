    ...
    <div className="max-w-5xl mx-auto p-6 min-h-screen  text-gray-800">
      ...
      <div className="mt-12 p-6 bg-white shadow-lg rounded-lg">
        ...
        <div className="mt-4 text-center">
          ...
          <p className="text-gray-600">📍 Indore, India | PhD Researcher in Artificial Intelligence</p>
        </div>
        ...
        <div className="mt-6">
          ...
          <p className="text-gray-700 mt-2">
            Kuldeep Singh Rautela is a **PhD scholar specializing in AI and Machine Learning**,  
            focusing on **environmental data analytics and predictive modeling**.  
            His research aims to **enhance air pollution forecasting** using **deep learning models**.
          </p>
        </div>
